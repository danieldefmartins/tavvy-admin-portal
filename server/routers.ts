    ...
    create: protectedProcedure
      .input(
        z.object({
          ...
          cover_position: z.string().optional().default("center"),
          description: z.string().optional(),
          history: z.string().optional(),
          culture: z.string().optional(),
          famous_people: z.string().optional(),
          local_economy: z.string().optional(),
          major_companies: z.string().optional(),
          political_leaning: z.string().optional(),
          then_now_next: z.string().optional(),
          ...
          avg_gas_price: z.number().optional(),
          is_featured: z.boolean().default(false),
      ...
      .mutation(async ({ input }) => {
        const id = await createCity({
          ...
          cover_image_url: input.cover_image_url || null,
          thumbnail_image_url: input.thumbnail_image_url || undefined,
          thumbnail_position: input.thumbnail_position || "center",
          cover_position: input.cover_position || "center",
    ...
    create: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        const id = await createUniverse({
          ...
          thumbnail_fit: input.thumbnail_fit || "cover",
          thumbnail_position: input.thumbnail_position || "center",
          banner_fit: input.banner_fit || "cover",
          banner_position: input.banner_position || "center",
    ...
    create: protectedProcedure
      .input(
        z.object({
          ...
          gets_wet: z.string().optional(),
          single_rider: z.boolean().optional(),
          child_swap: z.boolean().optional(),
          lightning_lane: z.string().optional(),
      ...
      .mutation(async ({ input }) => {
        const id = await createRide({
          ...
          gets_wet: input.gets_wet || null,
          single_rider: input.single_rider,
          child_swap: input.child_swap,
          lightning_lane: input.lightning_lane || null,
